...
func TestBls(t *testing.T) {
	...
	masterSkWithMnemonic := bls.KeyGenWithMnemonic(testMnemonic, "")
...
func TestKeyGen(t *testing.T) {
	sk, err := bls.KeyFromHexString(testHexString)
	if err != nil {
		t.Error(err)
		return
	}
